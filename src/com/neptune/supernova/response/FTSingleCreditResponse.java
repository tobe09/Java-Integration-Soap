...
public class FTSingleCreditResponse {
	...
	public FTSingleCreditResponse(){		
	}


	public FTSingleCreditResponse(String sessionId, String nameEnquiryRef, String channelCode,
			String destinationInstitutionCode, String beneficiaryAccountName, String beneficiaryAccountNumber,
